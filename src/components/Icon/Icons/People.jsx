...
const PeopleIcon = createIconComponent({
  content: (
    <g>
      <path fillRule="evenodd" d="M11.48 9c1.363 0 2.467-1.12 2.467-2.5S12.843 4 11.48 4 9.013 5.12 9.013 6.5 10.118 9 11.48 9zM4.575 8c1.634 0 2.96-1.343 2.96-3s-1.326-3-2.96-3c-1.635 0-2.96 1.343-2.96 3s1.325 3 2.96 3z" clipRule="evenodd" />
