...
const DayIcon = createIconComponent({
  content: (
    <g>
      ...
      <path fillRule="evenodd" d="M1 4.16v9.661a1 1 0 001 1h11.9a1 1 0 001-1v-8.94a1.98 1.98 0 01-3.825-.72V2.41h-1.09v1.75a1.98 1.98 0 11-3.96 0V2.41H4.96v1.75a1.98 1.98 0 11-3.96 0zm6.092 7.915L5.277 10.26a.792.792 0 011.12-1.12l.695.696L9.57 7.358a.792.792 0 011.12 1.12l-3.598 3.597z" clipRule="evenodd" />
