...
describe('AutoSuggest component', () => {
  ...
  it('handleSelectOption: should call onSelectClick', () => {
    ...
    const wrapper = shallow(<AutoSuggest onSelectClick={onSelectClickSply} items={[]} label="Select" />);
    const instance = wrapper.instance();
  ...
  it('onClick: should call stopImmediatePropagation', () => {
    ...
    const wrapper = shallow(<AutoSuggest onSelectClick={() => true} items={[]} label="Select" />);
    const instance = wrapper.instance();
  ...
  it('onAddItem: should call onSelectClick', () => {
    ...
    const wrapper = shallow(<AutoSuggest onSelectClick={onSelectClick} items={[]} label="Select" />);
    const instance = wrapper.instance();
    instance.onAddItem();
