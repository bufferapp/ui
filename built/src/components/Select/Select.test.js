...
describe('Select component', () => {
    it('openPopup: should open the closed popup', () => {
        const wrapper = mount(React.createElement(Select, { onSelectClick: () => true, items: [], label: "Select" }));
    ...
    it('componentDidUpdate: run onButtonClick when isOpen prop changes', () => {
        const wrapper = shallow(React.createElement(Select, { onSelectClick: () => true, isOpen: false, items: [], label: "Select" }));
        const instance = wrapper.instance();
    ...
    it('componentDidUpdate: should run filterOnMenuOpen on open if clearSearchOnBlur is false and search value exists in state', () => {
        const wrapper = mount(React.createElement(Select, { onSelectClick: () => true, items: [], label: "Select", clearSearchOnBlur: false }));
        const instance = wrapper.instance();
    ...
    it('componentDidUpdate: should clear search value on close if clearSearchOnBlur is true', () => {
        const wrapper = mount(React.createElement(Select, { onSelectClick: () => true, items: [], label: "Select", clearSearchOnBlur: true }));
        const instance = wrapper.instance();
    ...
    it('handleSelectOption: should call onSelectClick', () => {
        ...
        const wrapper = shallow(React.createElement(Select, { onSelectClick: onSelectClickSply, items: [], label: "Select" }));
        const instance = wrapper.instance();
    ...
    it('handleSelectOption: should call onSelectClick for custom items', () => {
        ...
        const SelectComponent = (React.createElement(Select, { label: "Select", onSelectClick: (selectedItem) => selectedItem.selectedItemClick(), items: items }));
    ...
    it('onClick: should call stopImmediatePropagation', () => {
        ...
        const wrapper = shallow(React.createElement(Select, { onSelectClick: () => true, items: [], label: "Select" }));
        const instance = wrapper.instance();
    ...
    it('onSearchChange: should update search in state', () => {
        const wrapper = shallow(React.createElement(Select, { onSelectClick: () => true, items: [
                {
                    id: '1',
                    title: 'Testing',
                },
    ...
    it('onAddItem: should not call handleSelectOption if hoveredItem is not set in state', () => {
        const wrapper = shallow(React.createElement(Select, { items: [], label: "Select" }));
        const instance = wrapper.instance();
    ...
    it('onAddItem: should call handleSelectOption if hoveredItem is set in state', () => {
        ...
        const wrapper = shallow(React.createElement(Select, { items: items, label: "Select" }));
        const instance = wrapper.instance();
