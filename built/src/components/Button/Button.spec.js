...
test('Button renders styles properly', () => {
    const tree = renderer
        .create(React.createElement(Button, { type: "primary", onClick: () => { }, label: "Primary" }))
        .toJSON();
...
test('Disabled button is disabled', () => {
    const tree = renderer
        .create(React.createElement(Button, { type: "primary", onClick: () => { }, label: "Primary", disabled: true }))
        .toJSON();
...
test('Primary default loading button has a darker blue background', () => {
    const tree = renderer
        .create(React.createElement(Button, { type: "primary", onClick: () => { }, label: "Primary", loading: true }))
        .toJSON();
