...
import { blueLightest50, grayDarker, grayLight50, gray, grayDark, blue, } from '../style/colors';
...
export const ItemStyled = styled.li `
  ...
  background-color: ${(props) => props.selected ? blueLightest50 : 'transparent'};

  &:hover {
    background-color: ${(props) => props.selected ? blueLightest50 : grayLight50};
