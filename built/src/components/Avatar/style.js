...
const getImageCss = ({ size, type = 'default' }) => css `
    width: ${size}px;
    height: ${size}px;
    border-radius: 100%;
    ...
    src}) center no-repeat, url(${(props) => props.fallbackUrl}) center no-repeat;
