...
export default function ExampleDropdownMenu() {
    return (React.createElement(Navigation, null,
        React.createElement(DropdownMenu, { ariaLabel: "Help Menu", ariaLabelPopup: "Help", menubarItem: React.createElement(MenuItem, null, "Menu"), items: menuItems, xPosition: "left", onOpen: () => console.log('----- onOpen Event') })));
}
//# sourceMappingURL=DropdownMenuWithOnOpenEvent.js.map