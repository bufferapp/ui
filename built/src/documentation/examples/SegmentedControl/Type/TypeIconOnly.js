...
export default function ExampleTypeIconOnly() {
    ...
    return (React.createElement("div", { style: { display: 'inline-block' } },
        React.createElement(SegmentedControl, null, options.map(({ disabled, icon, label, value, tooltip }, index) => (React.createElement(SegmentedControl.Option, { key: `${value}-${index}`, optionType: "icon", disabled: disabled, icon: icon, label: label, value: value, tooltip: tooltip, selected: value === selected, onClick: setSelected }))))));
}
//# sourceMappingURL=TypeIconOnly.js.map