...
export default function ExampleTypeTextOnly() {
    ...
    return (React.createElement("div", { style: { display: 'inline-block' } },
        React.createElement(SegmentedControl, null, options.map(({ disabled, icon, label, value, tooltip }, index) => (React.createElement(SegmentedControl.Option, { key: `${value}-${index}`, optionType: "text", disabled: disabled, icon: icon, label: label, value: value, tooltip: tooltip, selected: value === selected, onClick: setSelected }))))));
}
//# sourceMappingURL=TypeTextOnly.js.map