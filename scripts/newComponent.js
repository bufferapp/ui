...
async function main() {
  console.log(`⚡️ Let's create a new component ${username}! (Press Ctrl+C to cancel)\n`);
  ...
  templateFiles.forEach((templateFilePath) => {
    ...
    const newFileContent = templateContent.replace(new RegExp(`${templateComponentName}`, 'g'), answers.name);
